...
public class addingNumbers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseContacts=new DatabaseContacts(addingNumbers.this);
        ...
        btn_add.setOnClickListener(v -> {
            ...
            try{
                ...
                Toast.makeText(addingNumbers.this,"Contact added",Toast.LENGTH_SHORT).show();

            }
            catch (Exception e){
                Toast.makeText(addingNumbers.this,"Error creating contact",Toast.LENGTH_SHORT).show();
                con=new Contacts( -1,"Error","Error",false);
            }
            DatabaseContacts databaseContacts=new DatabaseContacts(addingNumbers.this);
    ...
    private void ShowContactsOnListView(DatabaseContacts databaseContacts2) {
        contactArrayAdapter = new ArrayAdapter<>(addingNumbers.this, android.R.layout.simple_list_item_1, databaseContacts2.getEveryone());
